...
import static com.example.constant.Constant.MIEN_TRUNG_URL;


public class MienTrungFragment extends Fragment {
    RecyclerView recyMienTrung;
    ...
    private void addControls() {
        ...
        recyMienTrung= view.findViewById(R.id.recycle_mien_trung);
        recyMienTrung.setLayoutManager(new LinearLayoutManager(view.getContext(),RecyclerView.HORIZONTAL,false));
        recyMienTrung.addItemDecoration(new DividerItemDecoration(view.getContext(),RecyclerView.HORIZONTAL));
        ketQuaAdapter= new KetQuaAdapter(view.getContext(),ketQuas);
        recyMienTrung.setAdapter(ketQuaAdapter);
    ...
    class GetKetQuaTak extends AsyncTask<Void,Void,ArrayList<KQSX>> {
        ...
        protected ArrayList<KQSX> doInBackground(Void... voids) {
            ...
            try {
                URL url= new URL(BASE_URL+MIEN_TRUNG_URL);
